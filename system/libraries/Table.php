...
*/
/**
* Extended HTML table class with tfoot support
*
* Added support for Table Footer
* Usage $this->table->set_footer('col1','col2');
* Code for table footer from https://github.com/EllisLab/CodeIgniter/wiki/Table
* merged with core CI_Table
* @author steve.lawrence@hsdc.ca
*/
class CI_Table
{
var $rows = array();
