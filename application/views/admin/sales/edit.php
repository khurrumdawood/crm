                    ...
                    <div class="row">
                      <section class="col col-11">
                        <label class="input"> <i class="icon-prepend fa fa-user"></i>
                            <input type="text" name="fname" placeholder="Name*" value="<?php echo $contact[0]->name; ?>">
                        </label>
                      </section>
<!--                      <section class="col col-11">
                        <label class="input"> <i class="icon-prepend fa fa-user"></i>
                    ...
                    <div class="row">
                        ...
                        <label class="input"> <i class="icon-prepend fa fa-phone"></i>
                          <input type="tel" name="phone" placeholder="Phone" value="<?php echo $contact[0]->phone; ?>">
                        </label>
                      </section>
                      <section class="col col-11">
                        <label class="input"> <i class="icon-prepend fa fa-envelope"></i>
                          <input type="email" name="email" placeholder="E-mail" value="<?php echo $contact[0]->email; ?>">
                        </label>
                      </section>
                    </div>
                  </fieldset>
...
<div class="row">
    <section class="col col-5">
        ...
        <label class="select">
            <?php echo countryDropdown('country_a', 'country_a', $contact[0]->country, '', 'Select Country'); ?>
            <i></i>
        </label>
    </section>
    ...
    <section class="col col-4">
        ...
        <label class="select">
            <?php echo stateDropdown($contact[0]->country, "state_a", "state_a", $contact[0]->state); ?>
            <i></i>
        </label>
    </section>
    ...
    <section class="col col-3">
        ...
        <label class="select">
            <?php echo cityDropdown($contact[0]->state, "city_a", "city_a", $contact[0]->city); ?>
            <i></i>
        </label>
    </section>
...
<!--                      <section class="col col-5">
                        <label class="select">
                          <?php 
//                          echo countryDropdown('country_a','country_a',$contact[0]->country,'', 'Select Country' ,' data-placeholder="Select Country" '); ?>
                          <i></i> </label>
                      </section>
                      <section class="col col-4">
                        <label class="input">
                          <input type="text" name="city" placeholder="City*" value="<?php echo $contact[0]->city; ?>">
                        </label>
                      </section>-->
                      <section class="col col-3">
                        <label class="input">
                          <input type="text" name="code" placeholder="Postal code" value="<?php echo $contact[0]->postal_code; ?>">
                        </label>
                      </section>
                    </div>
<!--                    <section>
                    ...
                    <section>
                      <label class="textarea">
                        <textarea rows="1" name="address" placeholder="Address*"><?php echo $contact[0]->shipping; ?></textarea>
                      </label>
                    </section>
                  </fieldset>
<!--                  <fieldset>
                      ...
                      <div class="row">
                        <div class="col col-4">
                          <label class="checkbox">
                            <input type="checkbox" id="bill_check" name="checkbox" onclick="billing_check()">
...
<div class="row">
    <section class="col col-8">
        ...
        <label class="select">
            <?php echo countryDropdown('b_country', 'b_country', $contact[0]->b_country, '', 'Select Country'); ?>
            <i></i>
        </label>
    </section>
...
<div class="row">
    <section class="col col-8">
        ...
        <label class="select">
            <?php echo stateDropdown($contact[0]->b_country, "b_state", "b_state", $contact[0]->b_state); ?>
            <i></i>
        </label>
    </section>
...
<div class="row">
    <section class="col col-8">
        ...
        <label class="select">
            <?php echo cityDropdown($contact[0]->b_state, "b_city", "b_city", $contact[0]->b_city); ?>
            <i></i>
        </label>
    </section>
...
<!--                      <section class="col col-8">
                        <label class="select">
                          <?php 
//                          echo countryDropdown('b_country','b_country', $contact[0]->b_country ,'', 'Select Country' ,' data-placeholder="Select Country" '); ?>
                          <i></i> </label>
                      </section>
                      <section class="col col-8">
                        <label class="input">
                          <input type="text" name="b_city" placeholder="City" value="<?php echo $contact[0]->b_city; ?>">
                        </label>
                      </section>-->
                      <section class="col col-8">
                        <label class="input">
                          <input type="text" name="b_code" placeholder="Post code" value="<?php echo $contact[0]->b_postal_code; ?>">
                        </label>
                      </section>
                    </div>
<!--                    <section>
     ...
     <section>
                      <label class="textarea">
                        <textarea rows="1" name="b_address" placeholder="billing Address"><?php echo $contact[0]->b_shipping; ?></textarea>
                      </label>
                    </section>
