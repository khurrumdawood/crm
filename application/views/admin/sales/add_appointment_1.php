                  ...
                  <!--<fieldset>-->
                    <section class="col col-6">
                      ...
                      <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
                          <input type="text" name="dates" id="date" placeholder="Date">
                      </label>
                    </section>
                  <!--</fieldset>-->
                <!--</form>-->
...
<!--            </div>-->
                            ...
                            <div class="row">
                                <section class="col col-6">
                                    <label class="select"> 
                                <?php 
                                echo timeValue($name = 'reminder', $id = 'reminder', $class='', $check = '','Reminder') ?>
                                        <i></i> 
                                    </label>
                            ...
                            <div class="row">
                                <section class="col col-6">
                                    <label class="input"> <i class="icon-prepend fa fa-tasks"></i>
                                        <input type="text" name="aa_task" placeholder="Add Task">
                                    </label>
                                </section>
                            </div>
                            <div class="row">
                                <section>
                                    <label class="textarea col col-6">
                                        <textarea rows="1" name="venue_add" placeholder="Appointment Venue/Address"></textarea>
                                    </label>
