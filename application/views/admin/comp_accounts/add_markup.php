...
<!--                            <div class="row">
                                <section class="col col-11">
                                    <label class="input"> <i class="icon-prepend fa fa-archive"></i>
                                        <input type="text" name="title" placeholder="ID*" value="">
                                    </label>
                                </section>
...
<!--                            <div class="row">
                                <section class="col col-11">
                                    <label class="input"> <i class="icon-prepend fa fa-arrow-up"></i>
                                        <input type="text" name="markup_type" placeholder="Markup Type" value="">
                                    </label>
                                </section>
                            </div>-->
                            ...
                            <section class="col col-11">
                                <label class="select">
                                    <?php echo carrierDropdown('carrier_id','carrier_id','','','Select Carrier'); ?>
                                    <i></i> </label>
                            </section>
