                        ...
                        <fieldset>
                                ...
                                <section class="col col-6">
                                    ...
                                    <div class="inline-group">
                                        <label class="checkbox">
                                            <input type="checkbox" name="potential" id="potential" value="potential" <?php
                                            if ($contact[0]->is_potential == 1) {
                                                echo "checked";
                                            }
                                            ?>>
                                            <i></i>
                            ...
                            <div class="row">
                                ...
                                <section class="col col-6">
                                    ...
                                    <label class="input">  
                                        <input type="text" name="area" id="area" value="<?php echo $contact[0]->area; ?>">
                                        <i></i>
                                    </label>
                                </section>
                            ...
                            <div class="row">
                                ...
                                <section class="col col-6">
                                    ...
                                    <label class="select">
<?php echo salesDropdown('sales_rep', 'sales_rep', $contact[0]->create_employee_id, '', 'Sales_rep', ' data-placeholder="Sales_rep"'); ?>
                                        <i></i>
                                    </label>
                                </section>
