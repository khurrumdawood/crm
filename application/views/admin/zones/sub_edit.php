                    ...
                    <div action="" id="checkout-form" class="orb-form">
                        ...
                        <fieldset>
                            <div class="row">
                                <section class="col col-6">
                                    ...
                                    <label class="input"><i class="icon-prepend fa fa-navicon"></i>
                                        <input type="text" name="title" placeholder="Title" value="<?php echo $zones[0]->category_name; ?>"  >
                                    </label>
                                </section>
                            </div>
                            <?php if($cli_comp!=0){ ?>
                            <div class="row">
                                <section class="col col-6">
                                    <label class="input"><i class="icon-prepend fa fa-navicon"></i>
                                        <input type="text" name="margin" placeholder="Margin %" value="<?php echo $zones[0]->margin; ?>"  >
                                    </label>
                                </section>
                            </div>
                            <?php } ?>
