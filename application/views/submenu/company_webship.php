...
<ul id="menu">
    ...
    <?php // } else  { ?>
<!--                <li><a class="<?php if ($active_sub_link == 'manage_customer'): ?>active<?php endif; ?>" 
                       href="<?php echo base_url(); ?>index.php/admin/comp_accounts/webship_user_account" title="Manage Contacts">
                        <i class="entypo-briefcase"></i><span>Web Ship</span>
                    </a></li>-->
