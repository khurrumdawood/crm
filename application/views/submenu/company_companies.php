...
<ul id="menu"> 
        ...
        <li><a class="<?php if ($active_sub_link == 'companies'): ?>active<?php endif; ?>" href="<?php echo base_url(); ?>index.php/admin/companies/" title="Companies">
        <i class="entypo-briefcase"></i><span>Companies</span>
    </a>
        </li>
<!--          <ul id="dash-sub">
