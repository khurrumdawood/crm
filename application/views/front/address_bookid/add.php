                        ...
                        <fieldset>
                            ...
                            <!--                            <div class="row">
                                                            <section class="col col-6">
                                                                ...
                                                                <label class="input"><i class="icon-prepend fa fa-navicon"></i>
                                                                    <input type="text" name="contact_id" placeholder="Contact" value=""  >
                                                                </label>
                                                            </section>
                            ...
                            <div class="row">
                                <section class="col col-6">
                                    ...
                                    <label class="select">
<!--                                        <input type="text" id="sender_country" name="country" placeholder="Country" value=""  >-->
                                    <?php echo countryDropdown('country', 'sender_country', '', '', 'Select Country'); ?>
                                    <i></i>
                                    </label>
                                </section>
                            ...
                            <div class="row">
                                <section class="col col-6">
                                    ...
                                    <label class="select">
                                        ...
                                        <select id="sender_state" name="state">
                            ...
                            <div class="row">
                                <section class="col col-6">
                                    ...
                                    <label class="select">
                                        ...
                                        <select id="sender_city" name="city">
