...
/*    [class^="entypo-"]::after, [class*=" entypo-"]::after {
        display:  none;
    }*/
    .entypo-mail::before {
        display: none !important;
...
<!--                    <div class="btn-group pull-right">
                    ...
                    <!--Lock Screen--> 
<!--                    <a href="#" data-toggle="modal" class="btn btn-default hidden-xs pull-right lockme"> <i class="entypo-lock"></i>
                    </a> -->
...
<!--                                    <a href="#" class="list-group-item"><i class="fa fa-cog"></i>Settings</a> 
                ...
                <section id="main_menu">
                    <?php $this->load->view('menu/' . $user_type . '_menu'); ?>
