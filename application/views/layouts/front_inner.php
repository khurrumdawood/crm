...
?>
    ...
    <body>
        ...
        <div class="smooth-overflow">
            <!--Navigation-->
            <nav class="main-header clearfix" role="navigation"> <a style="width: 238px" class="navbar-brand" href="index.html"><span class="text-blue">PartnerShip</span></a> 
...
<!--                    <div class="tabs-offcanvas">
                        ...
                        <div class="tab-content"> 
                            ...
                            <div class="tab-pane active" id="userbar-one">
                                ...
                                <div class="list-group">
                                    ...
                                    <a data-toggle="modal" href="<?php echo base_url(); ?>index.php/admin/logout" class="list-group-item goaway"><i class="fa fa-power-off"></i> Sign Out</a>
                                </div>
                            </div>
                ...
                <div class="responsive-admin-menu <?php echo (isset($no_left))? 'sidebar-toggle':''; ?>">
                    <div class="responsive-menu">PartnerSHIP
                        <div class="menuicon"><i class="fa fa-angle-down"></i></div>
                    </div>


                    <?php if($active_sub_link){
                    $this->load->view('submenu/' . $user_type . '_' . $active_link);
                    }
                    ?>
