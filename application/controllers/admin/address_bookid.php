<?php class Address_bookid extends CI_Controller {
...
//        $data['active_sub_link'] = 'zones';
        ...
        $data['add_button'] = array('url' => base_url() . 'front/address_bookid/add_address_bookid', 'btn_title' => 'Add New Address_book');

        $tmpl = array('table_open' => '<table class="display table table-striped table-hover" id="table-4">');

        $this->table->set_template($tmpl);

        $this->table->set_heading("Id","Contact","Company","Address","Address2","City","State/Province","Postal Code","Country","Phone","Edit","Delete");

        $this->table->set_footer(
                        '<input type="text" name="id" placeholder="Id" class="search_init" />',                
                        '<input type="text" name="contact_id" placeholder="Contact" class="search_init" />',                
                        ...
                        '<input type="text" name="state" placeholder="State/Province" class="search_init" />',                
    ...
    function address_bookiddatatable() {
        $select = 'id,contact_id,company,address,address2,city,state,postal_code,country,phone';
        $where = '';
