            ...
            $(document).ready(function () {
                ...
                $('.btn-minmax').click(function (e) {
                    ...
                    if ($target.is(':visible'))
                        $('i', $(this)).removeClass('fa fa-chevron-circle-up').addClass('fa fa-chevron-circle-down');
                    else
                        $('i', $(this)).removeClass('fa-chevron-circle-down').addClass('fa fa-chevron-circle-up');
                    $target.slideToggle();
                });
...
//
                    ...
                    if ($('#table-5').length) {
                        var oTable = $('#table-5').dataTable({
                            "sPaginationType": "bootstrap",
                            "oLanguage": {
                                "sSearch": "Search all columns:"
                            },
                            "bServerSide": true,
                            "sAjaxSource": table_url_5,
                            'fnServerData': function (sSource, aoData, fnCallback)
                            {
                                $.ajax
                                        ({
...
//
                ...
                if ($('#checkout-form-my').length) {
                    $('#checkout-form-my').validate({
                        // Rules for form validation
                        rules: {
                            status: {
                                required: true
                        ...
                        messages: {
                            ...
                            dates: {
                                required: 'Please set a specific date'
                            },
                            time: {
                                required: 'Please set a specific time'
                            },
                            appointment_type: {
...
//                            },
                            sales_rep: {
                                required: 'Please enter Sales representative'
                            }
...
//                            }
                ...
                if ($('#steps-wizard').length) {
                    $('#steps-wizard').validate({
                        ...
                        messages: {
                            ...
                            sender_phone: {
                                required: 'Please enter Sender Phone'
                            },
                            sender_contact_name: {
                            ...
                            zone_country: {
                                required: 'Please select services type'
                            },
                            ship_package: {
                                required: 'Please select package type'
                            },
                            ship_weight_unit: {
                                required: 'Please select weight unit'
                            },
                            ship_length_unit: {
                                required: 'Please select length unit'
                            },
                            currency: {
                                required: 'Please select currency unit'
                            },
                            ...
                            shipment_reference: {
                                required: 'Please enter shipment reference'
                            },
                            total_customes_values: {
                                required: 'Please enter total customes values'
                            },
                            commercial_invoice: {
                                required: 'Please select commercial invoice'
                            },
                            transport_charges: {
                                required: 'Please select transport charges'
                            },
                            account: {
                                required: 'Please enter account no.'
                            },
                            duties: {
                                required: 'Please select duties/taxes/fees'
                            },
                            amount: {
                                required: 'Please enter amount'
                            },
                            collection_option: {
                                required: 'Please select collection option'
                            }
                ...
                if ($('#chartjs-bar1').length > 0) {
                    new Chart(document.getElementById("chartjs-bar1").getContext("2d")).Bar(barChartData, barChartoptions);
                }

                if ($('#chartjs-bar2').length > 0) {
                    new Chart(document.getElementById("chartjs-bar2").getContext("2d")).Bar(barChartData, barChartoptions);
                }
